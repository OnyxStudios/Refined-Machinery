...
public class BlockCoalGen extends BlockWithEntityBase implements IWrenchable, BlockComponentProvider {
    ...
    public <T extends Component> T getComponent(BlockView blockView, BlockPos pos, ComponentType<T> type, @Nullable Direction side) {
        return type == DefaultTypes.CARDINAL_ENERGY ? (T) ((BlockEntityCoalGen) blockView.getBlockEntity(pos)).storage : null;
    }
