...
public class BlockPulverizer extends BlockWithEntityBase implements IWrenchable, BlockComponentProvider {

    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    public BlockPulverizer() {
        super("pulverizer", Material.STONE, 1.0f, RefinedMachineryClient.modItemGroup);
    ...
    public <T extends Component> T getComponent(BlockView blockView, BlockPos pos, ComponentType<T> type, @Nullable Direction side) {
        return type == DefaultTypes.CARDINAL_ENERGY ? (T) ((BlockEntityPulverizer) blockView.getBlockEntity(pos)).storage : null;
    }
